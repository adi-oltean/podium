...
certificates for abort safety, Karush--Kuhn--Tucker (KKT) certificates that give
an exact rational bound on the suboptimality of an approximate online convex
solve, and tolerance-free bounds on the global optimum of the
...
checker, computing an exact rational bound on the solution's suboptimality before
the command is used. The gap between a Python prototype and
...
inside the reference-mission loop. An interactive playback of the
