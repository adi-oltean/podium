...
certifiable trajectory optimization \cite{strom2024} and exact SDP relaxations
...
autocoding \cite{feron2013,cohen2020} autocodes convex-optimization solvers to
contract-annotated C; verified spacecraft control programs \cite{mokhov2018} and
