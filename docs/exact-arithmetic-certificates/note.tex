...
Section~\ref{sec:discipline}). Cite as \url{https://doi.org/10.5281/zenodo.21247380}.}}
\date{July 2026}
...
Taking the supremum over rational $\lambda \ge 0$ and $t$ with
...
bracket $[-3,\,-17520/11881]$ then encloses this nonconvex optimum, which has no
...
per-primitive problems these checkers target the rational entries stay small, and
