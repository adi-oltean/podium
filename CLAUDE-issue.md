...
```bash
gh -R adi-oltean/podium issue create --title "Title" --body-file tmp/issue-body.txt
```
...
```bash
gh -R adi-oltean/podium issue edit N --title "NN — Title"
```

Example: `gh issue edit 42 -R adi-oltean/podium --title "42 — New widget"`
...
GitHub issue: https://github.com/adi-oltean/podium/issues/N
...
```
[NN-slug.md](https://github.com/adi-oltean/podium/blob/main/docs/plans/NN-slug.md)
...
```bash
gh -R adi-oltean/podium issue edit N --body-file tmp/issue-body.txt
```
...
- **# column** (summary tables) — linked issue number:
  `[#N](https://github.com/adi-oltean/podium/issues/N)`
- **Item column** — link to the plan file:
  `[Title](https://github.com/adi-oltean/podium/blob/main/docs/plans/NN-slug.md)`
